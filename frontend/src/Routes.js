...
import DailyUploads from "./Home/DailyUploads";
import Comedians from "./Comedian/Comedians";
...
const Routes = ()=>{
    return(
        ...
        <Switch>
            ...
            <Route path="/daily-uploads" exact component={DailyUploads}/>
            ...
            <Route path = "/template/:templateId" exact component={Template}/>

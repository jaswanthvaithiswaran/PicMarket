            ...
            <div className="grid grid-cols-3 gap-7 mt-20 mb-20">
                    ...
                    <div className="bg-slate-100  rounded-lg shadow-lg">
                        ...
                        <div className="mb-4 ml-8">
                            <label className="block text-gray-700 text-sm font-bold mb-2" for="actor"> Actor</label>
                        ...
                        <div className="mb-4 ml-8">
                            <label className="block text-gray-700 text-sm font-bold mb-2" for="comedian"> Comedian </label>
                            <select name="" className="p-2 bg-white relative rounded text-sm w-3/4">

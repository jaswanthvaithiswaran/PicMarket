        ...
        <div className="flex bg-royal-blue ">
          ...
          <div className="w-1/2  h-12">
            <ul className="flex">
              ...
              <button class="btn inline-block px-4 py-1 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">

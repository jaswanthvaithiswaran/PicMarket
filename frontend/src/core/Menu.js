  ...
  history
    ...
    return(
      <div className="sticky top-0 z-10 bg-white backdrop-filter backdrop-blur-lg bg-opacity-30 border-b border-gray-200">
        <div className="">
        <div className="flex ">
          <div className=" w-2/3 h-6 text-center md:w-1/4 md:h-12">
        ...
        <div className="searchbar mt-2 flex ml-9  w-1/4 md:1/4">
                    <input type="search" className="form-control relative flex-auto min-w-0 block w-60 md:w-60 md:h-10 px-5 py-1 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search templates" aria-label="Search" aria-describedby="button-addon2"/>
